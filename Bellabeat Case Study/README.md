...
## Introduction
I am a junior data analyst working on the marketing analysis team at Bellabeat, a high-tech manufacturer of health-focused products for women. As a data analyst, I have been asked to focus on one of Bellabeat's products: Bellabeat app and analyze smart device fitness data to gain insights into how customers use their smart devices.The insights gained from my analysis will help guide Bellabeat's marketing strategy. I will present my findings and recommendations to Bellabeat executive team.
### About the company
